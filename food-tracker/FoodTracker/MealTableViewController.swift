...
class MealTableViewController: UITableViewController {
    ...
    static let AddItemSegueIdentifier = "addItem"
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier(MealTableViewController.ReuseIdentifier, forIndexPath: indexPath) as! MealTableViewCell
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        guard segue.identifier == MealTableViewController.ShowDetailSegueIdentifier else {
            if segue.identifier == MealTableViewController.AddItemSegueIdentifier {
        ...
        let destination = segue.destinationViewController as! MealViewController
